...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS NO-SCROLLBAR-VERTICAL SIZE 24 BY 4.05
         BGCOLOR 15  ROW-HEIGHT-CHARS .76 EXPANDABLE.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS NO-SCROLLBAR-VERTICAL SIZE 22 BY 3.57
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS NO-SCROLLBAR-VERTICAL SIZE 30 BY 2.62
         BGCOLOR 15  EXPANDABLE.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 23 BY 4.52
         BGCOLOR 15  EXPANDABLE.
...
DEFINE FRAME RegVenta-Frame
     Fecha AT ROW 4.81 COL 9 COLON-ALIGNED
     HoraEntrada AT ROW 4.81 COL 43.2 COLON-ALIGNED
     HoraSalida AT ROW 4.81 COL 73 COLON-ALIGNED
     BROWSE-20 AT ROW 4.81 COL 121
     BROWSE-9 AT ROW 6.71 COL 10
     BROWSE-2 AT ROW 6.71 COL 44
     BROWSE-11 AT ROW 6.71 COL 77
     Cantidad AT ROW 10.52 COL 140 COLON-ALIGNED
     BUTTON-1 AT ROW 10.52 COL 165
     Subtotal AT ROW 12.19 COL 51 COLON-ALIGNED
     BROWSE-3 AT ROW 12.43 COL 9
     IVA AT ROW 12.43 COL 76 COLON-ALIGNED
     SELECT-1 AT ROW 12.43 COL 121 NO-LABEL
     Propina AT ROW 14.1 COL 51 COLON-ALIGNED
     Total AT ROW 14.1 COL 76 COLON-ALIGNED
     BtnOK AT ROW 16.95 COL 9
     BtnCancel AT ROW 16.95 COL 25
     RECT-1 AT ROW 1 COL 1
     "REGISTRO DE VENTA" VIEW-AS TEXT
          SIZE 45 BY 1.19 AT ROW 1.62 COL 83
          BGCOLOR 8 FGCOLOR 15 FONT 12
     SPACE(63.99) SKIP(17.80)
...
------------------------------------------------------------------------------*/
  ...
  ENABLE HoraSalida BROWSE-20 BROWSE-9 BROWSE-2 BROWSE-11 Cantidad BUTTON-1 
         Subtotal BROWSE-3 IVA SELECT-1 Propina Total BtnOK BtnCancel RECT-1 
      WITH FRAME RegVenta-Frame.
